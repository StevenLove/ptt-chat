...
app.get('/*', function(req,res){
  ...
  if(mode == "translate"){
    ...
    var translate_success_callback = function(translated_string){
    ...
    TranslateOnceTokenIsUpToDate(GET_params.text,GET_params.from,GET_params.to, translate_success_callback);
  }
  else if( mode == "image2"){
    var window = {};
...
google.loader.ClientLocation = {"latitude":35.775,"longitude":-78.634,"address":{"city":"Raleigh","region":"NC","country":"USA","country_code":"US"}};
